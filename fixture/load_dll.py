...
import re
from parse import search, findall, compile
...
class DllHelper:
    def __init__(self, message=None, cb1=None, cb2=None, cb3=None, obj_name=None, obj_id=None, p=None, l=None):
    ...
    def callback(self, cb1, cb2, cb3):
        ...
        #print(cb1.decode("latin-1"))  #заменил utf-8 на latin-1 из за ошибки "utf-8' codec can't decode byte 0xc8 in position 21: invalid continuation byte"
        #print(cb2)
        #print(cb3)
        self.cb1 = cb1
